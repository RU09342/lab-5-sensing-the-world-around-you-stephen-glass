/*
Stephen Glass
msp430fr2311_photodiode.c : nightlight functionality, when it is dark turn on an LED
MSP430FR2311
*/
...
__interrupt void Timer0_B0 (void)
{
    ...
    */
    ...
    // 1.09802 / 2 = 0.5V
    if (ADC_Result < 0xC8) P1OUT &= ~BIT0;               // Clear P1.0 LED off (less than 200)
    else // If its greater than 200 (dark condition)
    {
