/*
Stephen Glass
msp430fr2311_pressure.c : control a LED by using a pressure sensitive sensor
MSP430FR2311
*/
...
void initADC(void)
{
    ...
    ADCMCTL0 |= ADCINCH_2 | ADCSREF_1;                        // A2 ADC input select; Vref=1.5V
...
__interrupt void Timer0_B0 (void)
{
    ...
    // 1.09802 / 2 = 0.5V
    if (ADC_Result < 0x155) P1OUT &= ~BIT0;               // Clear P1.0 LED off
    else
    {
